...
public:
	...
	color_t get_line_color() { return color_line; }	
...
public:
	...
	point_t get_3();
	int get_thickness() { return thickness;}
	color_t get_border_color() { return border_color; }
	bool get_fill_or_no() { return fill_or_no; }
};
//------------------------
class drawing_t
{
public:
	...
	void save(color_t **buffer,int H,int W);
	void load(color_t **buffer,int H, int W);
